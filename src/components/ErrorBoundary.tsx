      ...
      try {
        if (this.state.error?.message) {
          ...
          if (parsed.operationType && parsed.authInfo) {
            ...
            errorMessage = `Firestore xatoligi: ${parsed.operationType} operatsiyasi muvaffaqiyatsiz tugadi. ${parsed.error}`;
          }
        }
      } catch (e) {
        // Not a JSON error
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
          <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 text-center space-y-6">
            ...
            {isFirestoreError && (
              <p className="text-xs text-gray-400 bg-gray-50 p-3 rounded-xl break-all">
